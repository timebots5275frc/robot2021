...
m_steerMotor = new CANSparkMax(steerMotorID,
CANSparkMaxLowLevel.MotorType.kBrushless);
...
return new SwerveModuleState(speedMetersPerSecond, new
Rotation2d(m_steerEncoder.getAbsolutePosition()));
}
...
m_drivePIDController.calculate(m_driveMotorEncoder.getVelocity(),
...
double turnOutput =
PID_Encoder_Steer.calculate(m_steerEncoder.getAbsolutePosition(),
state.angle.getDegrees() );

final double turnFeedforward =
m_turnFeedforward.calculate(PID_Encoder_Steer.getSetpoint());
