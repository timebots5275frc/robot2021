...
public class RobotContainer {
	...
	public RobotContainer() {
		...
		driveTrain.setDefaultCommand(driveJoyCommand); // fieldRelative = false
	...
	public Command getAutonomousCommand() {
		...
		List<Translation2d> listTranslation2d = List.of(new Translation2d(2, 2), new Translation2d(6, 2),
