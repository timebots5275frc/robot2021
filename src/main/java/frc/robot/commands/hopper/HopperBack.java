...
public class HopperBack extends CommandBase {
  private Hopper subsystem;

  /** Creates a new HopperFire. */
  public HopperBack(Hopper subsystem) {
  ...
  public void execute() {
    ...
    this.subsystem.setMototrSpeed(Constants.HopperConstants.HOPPER_BACK_SPEED);
  }
